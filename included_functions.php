...
<?php
	...
	function new_header($name="Diana Salinas", $urlLink="https://turing.cs.olemiss.edu/~dcsalina") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~dcsalina/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";
	...
	function new_footer($name="Diana Salinas"){
